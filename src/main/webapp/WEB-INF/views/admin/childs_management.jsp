...
<body data-ng-app="my-app"  data-ng-controller="Ctrl">
        ...
        <div class="wrapper">
            ...
            <div id="content" class="container">
				...
				<div class="row">
					<form class="col-md-12" name="Projectform" action='<c:url value="/admin/mng_childs" />' method="post">
						<div class="col-md-9 col-md-offset-2">
								...
								<c:choose>
									<c:when test="${result == 'done' }">
										<div class="alert alert-success alert-dismissible">
										 ...
										 <strong>Well Done!</strong> ChildRubric successfully saved
										</div>
									</c:when>
									<c:otherwise>
							...
							<div class="form-group">
								...
								<select name="project" class="form-control" data-ng-model="project" data-ng-change="getData()">
							...
							<div class="form-group">
								...
								<select name="rubric" class="form-control" data-ng-model="rubric" >
							...
							<div class="form-groupe">
								 ...
								 <a href='<c:url value="/admin/mng_rubrics" />' class="col-md-offset-1 col-md-2 btn btn-info" >Go Back</a>
							</div>																													
						</div>
						</form>
				</div> 					
