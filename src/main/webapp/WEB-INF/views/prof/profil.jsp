						...
						<table class="table table-bordered">
							...
							<tbody>
								<c:forEach items="${dashboard}" var="d">
									<tr>
										<td> <a href='<c:url value="/prof/detail_project?id_project=${d.id_projet}" />' style="color: green" target='_blank'  >${d.project}</a> </td>
										<td> ${d.team} </td>
										<td> ${d.amount} </td>
										<td> ${d.year} </td>
										<td> <a class="btn btn-danger" href='<c:url value="/prof/log_project?id_project=${d.id_projet}" />' >View Log</a> </td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
